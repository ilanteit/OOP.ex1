...
class WGraph_AlgoTest {
    ...
    void isConnected() {
        ...
        g0 = WGraph_DSTest.graph_creator(100000,1000000,1);
        ag0.init(g0);
    ...
    @Test
    void shortestPath2() {
        weighted_graph g0 = small_graph2();
        weighted_graph_algorithms ag0 = new WGraph_Algo();
        ag0.init(g0);
        List<node_info> sp = ag0.shortestPath(0,3);
        if(sp==null)
        assertFalse(ag0.isConnected());
    ...
    @Test
    void save_load() {
        weighted_graph g0 = WGraph_DSTest.graph_creator(100000,10000,1);
        weighted_graph_algorithms ag0 = new WGraph_Algo();
        ag0.init(g0);
        String str = "g0.obj";
        ag0.save(str);
        weighted_graph g1 = WGraph_DSTest.graph_creator(100000,10000,1);
        ag0.load(str);
        assertEquals(g0,g1);
        g0.removeNode(0);
    ...
    private weighted_graph small_graph2() {
